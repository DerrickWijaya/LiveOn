...
<div class="auth-container" style="display: flex; min-height: 100vh; background: #ffffff; font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, 'Helvetica Neue', sans-serif;">
    ...
    <div class="auth-left" style="flex: 1; background: linear-gradient(135deg, rgba(0,0,0,0.6) 0%, rgba(80,20,80,0.8) 100%), url('https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=700&h=900&fit=crop'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; padding: 40px; color: white; min-height: 100vh;">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="email" id="email" placeholder="Enter your email" class="form-control @error('email') is-invalid @enderror" 
                        required autocomplete="new-password" style="padding: 10px 12px; border: 1px solid #ddd; border-radius: 6px; font-size: 0.9rem; width: 100%; background: #fafbfc;">
                    @error('email')
                ...
                <button type="submit" style="width: 100%; padding: 11px; background: linear-gradient(135deg, #7C5CEE, #FF6B9D); color: white; border: none; border-radius: 6px; font-weight: 600; font-size: 0.95rem; cursor: pointer; transition: 0.3s; margin-top: 4px;">
                    Log In
                </button>
            </form>
